...
class GreenBatteryView: UIView {
   ...
   func commonInit() {
       Bundle.main.loadNibNamed("GreenBatteryView", owner: self, options: nil)
       self.addSubview(contentView)
       contentView.frame = self.bounds
        contentMode = .redraw
       self.backgroundColor = .clear
       contentView.backgroundColor = .clear
       indicatorView.isRed = false
       figureView.isRed = false
   }
